...
public class Jay
{
    ...
    string[] Skills = { "C#", ".Net 6", "GO lang", "Blazor", "SQL", "WebAPI", "Azure Functions", "Azure Devops", "PostGre SQL", "My SQL", "React js", "Entity Framework Core", "AWS Lamda", "Rest APIs", "Swagger", "New Relic", Design Patterns };
